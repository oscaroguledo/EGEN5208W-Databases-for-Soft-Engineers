...
class Equipment(Base):
    ...
    def __repr__(self):
        return f"<Equipment(id='{self.id}', room_id='{self.room_id}', equipment_name='{self.equipment_name}', status='{self.status}', created_at='{self.created_at}', deleted_at='{self.deleted_at}')>"
